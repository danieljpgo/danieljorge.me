...
<Playground description="Hover over to see the circle follow the mouse">
  <SpotlightThird />
</Playground>
...
<Playground description="Hover over and move out to see the effect appear and disappear.">
  <SpotlightFourth />
</Playground>
