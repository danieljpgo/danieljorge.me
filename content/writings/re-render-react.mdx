...
Now that we can measure improvements or ~make regressions~, we can use [Performance Hooks](https://react.dev/reference/react#performance-hooks):

- [useMemo](https://react.dev/reference/react/useMemo)
- [useCallback](https://react.dev/reference/react/useCallback)

The first two hooks presented, useMemo and useCallback are commonly used to optimize re-rendering performance, allowing to skip unnecessary work. These hooks, using [Memoization](https://en.wikipedia.org/wiki/Memoization) techniques, make it possible to cache computationally costly calculations in memories or even not render again if the data has not changed, using a stable reference.
