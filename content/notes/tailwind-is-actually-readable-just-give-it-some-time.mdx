...
description: Another look at Tailwind's approach to writing CSS
...
Initially, this comes from Tailwind's own approach, the [Utility-First CSS](https://tailwindcss.com/docs/utility-first). This approach boils down to composing CSS classes to implement your styles, [Adam Wathan](https://twitter.com/adamwathan) has an excellent blog post on the subject, if you haven't read it yet I highly recommend it:
